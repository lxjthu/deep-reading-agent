...
### **5. 文献谱系**
这篇论文是站在哪些巨人的肩膀上？请分别找到：
- 作为本文研究起点的文献（1-3篇）
- 作为本文核心理论框架来源的文献（2-3篇）
- 为本文的分析视角合理性提供依据的文献（1-3篇）
- 为本文提供重要机制参考的文献（2-3篇）
- 为本文提供重要的实证方法借鉴的文献（3篇以上）

### **6. 理论基础**
核心理论基础是什么？（如：人力资本理论、委托代理理论）该理论在本文是如何应用的？包括哪些关键要素、分类维度和因果关系作用机制？

### **7. 待检验假说**
具体的 H1, H2 是什么？

### **8. 创新点**
这些假说与前人相比，新在哪里？具体是对前人哪些文献的哪个理论或假说做出了怎样的改进？比如维度的增加？视角的转换？新要素的引入？

### **9. 逻辑推演**
假说背后的微观机制是什么？（为什么 A 会导致 B？）

**格式要求**：
- 必须使用 `### **` 作为带编号小标题的标记
- 子项目使用 `-` 列表标记
- 使用专业、严谨的学术中文回答
- 只需针对每一个问题给出尽可能详细的解读，无需任何寒暄，不要添加任何前言
"""
